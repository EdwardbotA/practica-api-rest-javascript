...
const catergoriesPreviewList = document.querySelector('.categoriesPreview-list')
const movieDetailCatergoriesList = document.querySelector('#movieDetail .categories-list')
